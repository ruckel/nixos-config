...
static const char *brdn[]    = { "brightnessctl",   "set",   "5%-",      NULL };
static const char *br1up[]    = { "brightnessctl",   "set",   "1%+",      NULL };
static const char *br1dn[]    = { "brightnessctl",   "set",   "1%-",      NULL };
...
static const Key keys[] = {
	...
	{ MODKEY|ShiftMask,             XK_q,      quit,           {0} },
  	...
  	{ MODKEY,                       XK_F4,     spawn,          {.v = upvol   } },
        { MODKEY,                       XK_F5,     spawn,          {.v = brdn   } },
        { MODKEY,                       XK_F6,     spawn,          {.v = brup   } },
        { MODKEY|ShiftMask,             XK_F5,     spawn,          {.v = br1dn   } },
        { MODKEY|ShiftMask,             XK_F6,     spawn,          {.v = br1up   } },
	TAGKEYS(                        XK_1,                      0)
	TAGKEYS(                        XK_2,                      1)
	TAGKEYS(                        XK_3,                      2)
	TAGKEYS(                        XK_4,                      3)
