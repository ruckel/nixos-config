...
static const Rule rules[] = {
	...
	{ "Seahorse", NULL,       NULL,       8,            0,           -1 }, 
	{ "KeePassXC",NULL,       NULL,       8,            0,           -1 }, 
	{ "Ferdium",  NULL,       NULL,       7,            0,           -1 }, 
	{ "mpv",      NULL,       NULL,       0,            1,           -1 },
};
...
static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-fn", dmenufont, "-nb", col_gray1, "-nf", col_gray3, "-sb", col_cyan, "-sf", col_gray4, "-l", "20", "-p", "bah köör:",  NULL };
...
static const char *addlight[]   = { "brightnessctl",   "s",   "5%+", NULL };
static const char *sublight[]   = { "brightnessctl",   "s",   "5%-", NULL };
...
static const Key keys[] = {
	...
	{ MODKEY|ShiftMask,             XK_y,      spawn,          {.v = statusbar } },
	...
	{ ShiftMask,                    XK_F11,    spawn,          {.v = sublight } },
	{ ShiftMask,                    XK_F12,     spawn,          {.v = addlight   } },
